        ...
        <div class="comment-box">
         ...
         <% } %>
            ...
            %>
             ...
             %>
	            	<div>
		            	<input type="button" class="dpnone" onclick="replyBtn(this)" value="수정">
		            	...
		            	<input type="button" class="dpnone" onclick="deleteReply(<%= rno %>, this)" value="삭제">
	            	</div>
	          <% } %>
          <% } %>
	            </div>
